...
export async function verifySingleClaimByX(input: {
  ...
  // Search for tweets containing the verification code and @shareclawai mention, regardless of who posted it
  const query = `"${input.verificationCode}" @shareclawai -is:retweet -is:reply`;
